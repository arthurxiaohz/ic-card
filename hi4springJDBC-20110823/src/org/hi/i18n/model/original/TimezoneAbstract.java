...
/*     */ 
/*     */ public abstract class TimezoneAbstract extends BaseObject
...
/*  76 */     if (((timezone != null) && (this.timezone == null)) || (
/*  77 */       (this.timezone != null) && ((!this.timezone.equals(timezone)) || (timezone == null)))) {
/*  78 */       setDirty(true);
/*  79 */       this.oldValues.put("timezone", this.timezone);
/*     */     }
...
/* 115 */     if (!(other instanceof Timezone)) return false;
/* 116 */     Timezone castOther = (Timezone)other;
/*     */ 
...
/* 124 */     hcb.append("Timezone".hashCode());
...
/* 131 */       .append("timezone", this.timezone)
 ...
 * Qualified Name:     org.hi.i18n.model.original.TimezoneAbstract
