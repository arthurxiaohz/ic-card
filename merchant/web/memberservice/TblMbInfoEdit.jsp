...
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
		...
		<dl>
			<dt><hi:text key="卡号" entity="TblMbInfo"/>：</dt><dd><input type="text" name="tblMbInfo.cardNo" class="textInput" value="${tblMbInfo.cardNo}" maxlength="30"/></dd>
		</dl>
		<dl>
		...
		<dl>
			...
			<dd>
				<input type="text" name="tblMbInfo.createdDatetime" class="textInput date" readonly="readonly" pattern="yyyy-MM-dd HH:mm:ss"
