...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">	
			...
			<li>
				<label><hi:text key="金额" entity="TblActDebitCreditVoucher"/>:</label>
	...
	<table class="table" width="100%" layoutH="138" targetType="${targetType}">
		<thead>
			<tr>
				...
				<th orderField="lastUpdatedDatetime" class="${pageInfo.sorterName eq 'lastUpdatedDatetime' ? pageInfo.sorterDirection : ''}"><hi:text key="最后修改时间" entity="TblActDebitCreditVoucher"/></th>
				<th width="90">
					<c:choose>
