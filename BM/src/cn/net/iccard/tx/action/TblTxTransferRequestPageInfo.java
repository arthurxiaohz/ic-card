...
public class TblTxTransferRequestPageInfo extends PageInfoView{
	...
	protected  String  f_cardBalance;
 	protected  String  f_cardBalance_op;
	protected  Integer  f_cardSequence;
 	protected  String  f_cardSequence_op;
    ...
    public String getF_cardBalance() {
        return this.f_cardBalance;
    }
    
    public void setF_cardBalance(String f_cardBalance) {
        this.f_cardBalance = f_cardBalance;
    }
    
    public String getF_cardBalance_op() {
        return this.f_cardBalance_op;
    }
    
    public void setF_cardBalance_op(String f_cardBalance_op) {
        this.f_cardBalance_op = f_cardBalance_op;
    }
   
    public Integer getF_cardSequence() {
        return this.f_cardSequence;
    }
    
    public void setF_cardSequence(Integer f_cardSequence) {
        this.f_cardSequence = f_cardSequence;
    }
    
    public String getF_cardSequence_op() {
        return this.f_cardSequence_op;
    }
    
    public void setF_cardSequence_op(String f_cardSequence_op) {
        this.f_cardSequence_op = f_cardSequence_op;
    }
