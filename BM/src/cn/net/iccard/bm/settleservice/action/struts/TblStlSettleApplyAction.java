...
public class TblStlSettleApplyAction extends BaseAction {
	...
	public String settle() throws Exception {
		ClearingAccountService clearingAccountService = (ClearingAccountService) SpringContextHolder
				.getBean(ClearingAccountService.class);
		ICommonAccountResponse commonAccountResponse = clearingAccountService
				.doSettle();
		if (!EAccountResponse.S0000.equals(commonAccountResponse.getRespCode())) {
			returnCommand(commonAccountResponse.getRespMsg());
		}
