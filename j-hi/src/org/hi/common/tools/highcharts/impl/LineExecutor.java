...
import org.hi.common.tools.highcharts.context.Line;
 ...
 * @since 2011-08-18
 */
public class LineExecutor extends AbstractChartExecutor {
	/**
	 * 曲线图执行器构建函数
	 * @param tilte 标题名称
	 ...
	 */
	public LineExecutor(String tilte, List<String> categories, String yAxisTitle, String unit){
		init();
		...
		Line line = new Line();
		highchart.getPlotOptions().setLine(line);
