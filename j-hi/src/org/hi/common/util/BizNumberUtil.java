...
public class BizNumberUtil {
	...
	private static synchronized int getCountNumber(String propertyName, Class clazz, String prefix){
		Filter filter = null;
		if(prefix != null)
	 ...
	 * @return
	 */
	private static synchronized String getLastNumber(String propertyName, Class clazz, String prefix){
