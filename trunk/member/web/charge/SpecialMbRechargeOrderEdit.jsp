...
<form action="createCharge.action?navTabId=tblMbRechargeOrderList&callbackType=closeCurrent&ajax=1" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)">
<div class="pageContent">
	...
	<!-- 
		...
		<dl>
			<dt><hi:text key="交易金额" entity="TblMbRechargeOrder"/>：</dt><dd><input type="text" name="tblMbRechargeOrder.txAmount" class="textInput" value="${tblMbRechargeOrder.txAmount}" </dd>
		</dl>
		<dl>
