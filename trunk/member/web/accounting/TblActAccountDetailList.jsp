...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">	
			...
			<li>
				<label><hi:text key="处理状态" entity="TblActAccountDetail"/>:</label>
				<hi:search name="pageInfo.f_settleStatus" emu="handledStatus"/>
			</li>	  
			<li class="dateRange">
	...
	<table class="table" width="100%" layoutH="138" targetType="${targetType}">
		<thead>
			<tr>
				...
				<th orderField="settleStatus" class="${pageInfo.sorterName eq 'settleStatus' ? pageInfo.sorterDirection : ''}"><hi:text key="处理状态" entity="TblActAccountDetail"/></th>
		...
		<tbody>
			...
			<tr>
				...
				<td><input name="orderIndexs" value="${item.id}" type="checkbox"></td>
				    ...
				    <td><hi:select emu="handledStatus" name="tblActAccountDetails[${s.index}].settleStatus" isLabel="true"/></td>
