...
<div class="pageContent">
	...
	<div class="viewInfo" layoutH="97">
		...
		<dl>
			<dt><hi:text key="金额" entity="TblActAccountDetail"/>：</dt><dd>${tblActAccountDetail.amount/100}</dd>
		</dl>
		<dl>
		...
		<dl>
			<dt><hi:text key="余额" entity="TblActAccountDetail"/>：</dt><dd>${tblActAccountDetail.balance/100}</dd>
		</dl>
		<dl>
		...
		<dl>
			<dt><hi:text key="处理状态" entity="TblActAccountDetail"/>：</dt><dd><hi:select emu="handledStatus" name="tblActAccountDetail.settleStatus" isLabel="true"/></dd>
		</dl>
		<dl>
