...
public abstract class TblActTransferVoucherAbstract extends BaseObject implements Serializable{
	 ...
	 * 出账账户
	 */	
 	protected  ActAccount actAccountFrom;

 	 /**
	 * 入账账户
	 */	
 	protected  ActAccount actAccountTo;
    ...
    public ActAccount getActAccountFrom() {
        return this.actAccountFrom;
    }
    
    public void setActAccountFrom(ActAccount actAccountFrom) {
    		if((actAccountFrom != null && this.actAccountFrom == null) || 
				this.actAccountFrom != null && (!this.actAccountFrom.equals(actAccountFrom) || actAccountFrom == null)){
        		this.setDirty(true);
        		this.oldValues.put("actAccountFrom", this.actAccountFrom);
        	}
        this.actAccountFrom = actAccountFrom;
    }
    
    public ActAccount getActAccountTo() {
        return this.actAccountTo;
    }
    
    public void setActAccountTo(ActAccount actAccountTo) {
    		if((actAccountTo != null && this.actAccountTo == null) || 
				this.actAccountTo != null && (!this.actAccountTo.equals(actAccountTo) || actAccountTo == null)){
        		this.setDirty(true);
        		this.oldValues.put("actAccountTo", this.actAccountTo);
        	}
        this.actAccountTo = actAccountTo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblActTransferVoucher) ) return false;
		 TblActTransferVoucher castOther = ( TblActTransferVoucher ) other; 
   ...
   public int hashCode() {
        ...
        hcb.append(getId());
		hcb.append("TblActTransferVoucher".hashCode());
