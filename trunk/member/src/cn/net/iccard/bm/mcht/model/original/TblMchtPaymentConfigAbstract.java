...
public abstract class TblMchtPaymentConfigAbstract extends BaseObject implements Serializable{
   ...
   public void setParentEntity(BaseObject parent){
    ...
    public void setAuthorized(Integer authorized) {
    		if((authorized != null && this.authorized == null) || 
				this.authorized != null && (!this.authorized.equals(authorized) || authorized == null)){
        		this.setDirty(true);
        		this.oldValues.put("authorized", this.authorized);
        	}
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblMchtPaymentConfig) ) return false;
		 TblMchtPaymentConfig castOther = ( TblMchtPaymentConfig ) other; 
   ...
   public int hashCode() {
        ...
        hcb.append(getId());
		hcb.append("TblMchtPaymentConfig".hashCode());
