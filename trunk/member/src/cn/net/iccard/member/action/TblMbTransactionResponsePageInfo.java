...
public class TblMbTransactionResponsePageInfo extends PageInfoView{
	...
	protected  String  f_orgOrdedId;
 	protected  String  f_orgOrdedId_op;
	protected  Integer  f_amount;
 	protected  String  f_amount_op;
	protected  String  f_context;
 	protected  String  f_context_op;
	protected  Integer  f_state;
 	protected  String  f_state_op;
	protected  String  f_sourceIp;
 	protected  String  f_sourceIp_op;
    ...
    public String getF_ordedId() {
        return this.f_ordedId;
    }
    
    public void setF_ordedId(String f_ordedId) {
        this.f_ordedId = f_ordedId;
    }
    
    public String getF_ordedId_op() {
        return this.f_ordedId_op;
    }
    
    public void setF_ordedId_op(String f_ordedId_op) {
        this.f_ordedId_op = f_ordedId_op;
    }
    ...
    public String getF_orgOrdedId() {
        return this.f_orgOrdedId;
    }
    
    public void setF_orgOrdedId(String f_orgOrdedId) {
        this.f_orgOrdedId = f_orgOrdedId;
    }
    
    public String getF_orgOrdedId_op() {
        return this.f_orgOrdedId_op;
    }
    
    public void setF_orgOrdedId_op(String f_orgOrdedId_op) {
        this.f_orgOrdedId_op = f_orgOrdedId_op;
    }
    ...
    public void setF_state(Integer f_state) {
        this.f_state = f_state;
    }
    
    public String getF_state_op() {
        return this.f_state_op;
    }
    
    public void setF_state_op(String f_state_op) {
        this.f_state_op = f_state_op;
    }
   
    public String getF_sourceIp() {
        return this.f_sourceIp;
    }
    
    public void setF_sourceIp(String f_sourceIp) {
        this.f_sourceIp = f_sourceIp;
    }
    
    public String getF_sourceIp_op() {
        return this.f_sourceIp_op;
    }
    
    public void setF_sourceIp_op(String f_sourceIp_op) {
        this.f_sourceIp_op = f_sourceIp_op;
    }
