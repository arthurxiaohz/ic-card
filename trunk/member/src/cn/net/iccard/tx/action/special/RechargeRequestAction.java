...
//			Filter Filter = PageInfoUtil.populateFilter(TblMbInfo);
			...
			tblMbRechargeOrder.setTxStatus("1");
			...
			mbTransactionRequest.setRequestId(requestId);	//请求号
			...
			mbTransactionRequest.setChinfo(tblMbInfo.getRealName());
