...
public abstract class TblMchtUserAbstract extends HiUser implements Serializable{
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblMchtUser) ) return false;
		 TblMchtUser castOther = ( TblMchtUser ) other; 
   ...
   public int hashCode() {
		...
		hcb.append("TblMchtUser".hashCode());
