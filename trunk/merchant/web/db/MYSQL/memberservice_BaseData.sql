...
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100303, 0, '持卡人卡号', 'TblMbRechargeOrder', 1, 0);
--
delete from HI_Language where ID = 100304;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100304, 0, '交易类型', 'TblMbRechargeOrder', 1, 0);
--
delete from HI_Language where ID = 100305;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100305, 0, '交易发生时间', 'TblMbRechargeOrder', 1, 0);
--
delete from HI_Language where ID = 100306;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100306, 0, '交易金额', 'TblMbRechargeOrder', 1, 0);
--
delete from HI_Language where ID = 100307;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100307, 0, '交易完成时间', 'TblMbRechargeOrder', 1, 0);
--
delete from HI_Language where ID = 100308;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100308, 0, '交易状态', 'TblMbRechargeOrder', 1, 0);
--
delete from HI_Language where ID = 100309;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100309, 0, '异常代码', 'TblMbRechargeOrder', 1, 0);
--
delete from HI_Language where ID = 100310;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100310, 0, '创建时间', 'TblMbRechargeOrder', 1, 0);
--
...
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100406, 0, '创建时间', 'TblMbTransactionRequest', 1, 0);
--
delete from HI_Language where ID = 100407;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100407, 0, '持卡人卡号', 'TblMbTransactionRequest', 1, 0);
--
delete from HI_Language where ID = 100408;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100408, 0, '平台流水号', 'TblMbTransactionRequest', 1, 0);
--
delete from HI_Language where ID = 100409;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100409, 0, '交易完成时间', 'TblMbTransactionRequest', 1, 0);
--
delete from HI_Language where ID = 100410;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(100410, 0, ' 网关订单号', 'TblMbTransactionRequest', 1, 0);
--
...
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(101105, 0, '发送报文的IP地址', 'TblMbTransactionResponse', 1, 0);
--
delete from HI_Language where ID = 101106;
--
insert into HI_Language(ID, version, keyStr, entity, creator, isSystem) values(101106, 0, '创建时间', 'TblMbTransactionResponse', 1, 0);
--
