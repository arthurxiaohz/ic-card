...
public class TblActTransferVoucherPageInfo extends PageInfoView{
	...
	protected  Integer  f_deleted;
 	...
 	protected  ActAccountPageInfo actAccountFrom;
 	protected  ActAccountPageInfo actAccountTo;
	...
	public ActAccountPageInfo getActAccountFrom() {
		return actAccountFrom;
	}

	public void setActAccountFrom(ActAccountPageInfo actAccountFrom) {
		this.actAccountFrom = actAccountFrom;
	}
	public ActAccountPageInfo getActAccountTo() {
		return actAccountTo;
	}

	public void setActAccountTo(ActAccountPageInfo actAccountTo) {
