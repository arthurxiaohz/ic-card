...
public abstract class TblTxTransferRequestAbstract extends BaseObject implements Serializable{
	 ...
	 * 卡序号
	 */	
 	protected  Integer cardSequence;
    ...
    public void setCardBalance(String cardBalance) {
    		if((cardBalance != null && this.cardBalance == null) || 
				this.cardBalance != null && (!this.cardBalance.equals(cardBalance) || cardBalance == null)){
        		this.setDirty(true);
        		this.oldValues.put("cardBalance", this.cardBalance);
        	}
    ...
    public void setCardSequence(Integer cardSequence) {
    		if((cardSequence != null && this.cardSequence == null) || 
				this.cardSequence != null && (!this.cardSequence.equals(cardSequence) || cardSequence == null)){
        		this.setDirty(true);
        		this.oldValues.put("cardSequence", this.cardSequence);
        	}
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblTxTransferRequest) ) return false;
		 TblTxTransferRequest castOther = ( TblTxTransferRequest ) other; 
   ...
   public int hashCode() {
        ...
        hcb.append(getId());
		hcb.append("TblTxTransferRequest".hashCode());
   ...
   public String toString() {
       ...
       sb.append("id", this.id)
		...
		.append("cardBalance", this.cardBalance)
		.append("cardSequence", this.cardSequence)
