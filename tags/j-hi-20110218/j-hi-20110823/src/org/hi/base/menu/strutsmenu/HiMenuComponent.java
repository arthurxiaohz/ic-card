...
public class HiMenuComponent extends MenuComponent {
	 ...
	 * 根节点的js方法
	 */
	protected String rootJsFunctionName;
	...
	public String getRootJsFunctionName() {
		return rootJsFunctionName;
	}

	public void setRootJsFunctionName(String rootJsFunctionName) {
		this.rootJsFunctionName = rootJsFunctionName;
	}
