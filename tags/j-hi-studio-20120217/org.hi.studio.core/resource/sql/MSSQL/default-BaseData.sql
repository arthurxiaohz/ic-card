...
--增加sa超级管理员用户
SET IDENTITY_INSERT Hi_User ON
...
SET IDENTITY_INSERT Hi_User OFF
...
--
insert into Hi_AppSetting(version, appGroup, appName, appValue,description, creator) values(0, 'HOSTING', 'WEB_HOSTING', 'http://localhost:8080', '应用服务器地址', 0);
...
SET IDENTITY_INSERT HI_LanguageCode ON
--
...
SET IDENTITY_INSERT  HI_LanguageCode  OFF
--

SET IDENTITY_INSERT HI_languageStr ON
--
...
SET IDENTITY_INSERT  HI_languageStr  OFF
