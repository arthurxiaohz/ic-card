	...
	<div class="pageFormContent" layoutH="97">
		...
		<div class="tabs">
			...
			<div class="tabsContent" style="height:150px;">
				...
				<div>
					<table class="list nowrap" width="100%" itemDetail="staff.friendss">
						<thead>
							<tr>
						...
						<tbody>
							<c:forEach var="item" items="${staff.friendss}"  varStatus="s">
							<tr>
							<input type="hidden" name="staff.friendss[${s.index}].id" value="${item.id}"/>
							<input type="hidden" name="staff.friendss[${s.index}].version" value="${item.version}"/>
								<td>
									<input type="text" class=" required" name="staff.friendss[${s.index}].name" value="${item.name}" size="12" maxlength="30"/>
								</td>
								<td>
