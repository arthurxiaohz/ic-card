...
<form action="createCharge.action?navTabId=tblMbRechargeOrderList&callbackType=closeCurrent&ajax=1" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, process1)">
