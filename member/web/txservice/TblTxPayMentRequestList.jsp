...
<form id="pagerForm" action="tblTxPayMentRequestList.action">
...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="tblTxPayMentRequestList.action?lookup=${lookup}" onsubmit="return dwzSearch(this, '${targetType}');">
	<input type="hidden" name="pageInfo.pageSize" value="${pageInfo.pageSize}" />
	<div class="searchBar">
		<ul class="searchContent">	
			<li>
				<label><hi:text key="商户交易流水号" entity="TblTxPayMentRequest"/>:</label>
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="138" targetType="${targetType}">
		...
		<tbody>
			<c:forEach var="item" items="${tblTxPayMentRequests}" varStatus="s">
			<tr>
				<c:if test="${empty lookup}">
