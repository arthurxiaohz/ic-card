...
public class TblMbTransactionRequestPageInfo extends PageInfoView{
	...
	protected  String  f_chinfo;
 	protected  String  f_chinfo_op;
	protected  String  f_plTxTraceNo;
 	protected  String  f_plTxTraceNo_op;
	protected  String  f_currencyType;
 	protected  String  f_currencyType_op;
    ...
    public String getF_trancode() {
        return this.f_trancode;
    }
    
    public void setF_trancode(String f_trancode) {
        this.f_trancode = f_trancode;
    }
    
    public String getF_trancode_op() {
        return this.f_trancode_op;
    }
    
    public void setF_trancode_op(String f_trancode_op) {
        this.f_trancode_op = f_trancode_op;
    }
    ...
    public String getF_trxTime() {
        return this.f_trxTime;
    }
    
    public void setF_trxTime(String f_trxTime) {
        this.f_trxTime = f_trxTime;
    }
    
    public String getF_trxTime_op() {
        return this.f_trxTime_op;
    }
    
    public void setF_trxTime_op(String f_trxTime_op) {
    ...
    public String getF_pan() {
        return this.f_pan;
    }
    
    public void setF_pan(String f_pan) {
        this.f_pan = f_pan;
    }
    
    public String getF_pan_op() {
        return this.f_pan_op;
    }
    
    public void setF_pan_op(String f_pan_op) {
        this.f_pan_op = f_pan_op;
    }
   
    public String getF_chinfo() {
        return this.f_chinfo;
    }
    
    public void setF_chinfo(String f_chinfo) {
        this.f_chinfo = f_chinfo;
    }
    
    public String getF_chinfo_op() {
        return this.f_chinfo_op;
    }
    
    public void setF_chinfo_op(String f_chinfo_op) {
        this.f_chinfo_op = f_chinfo_op;
    }
    ...
    public String getF_currencyType() {
        return this.f_currencyType;
    }
    
    public void setF_currencyType(String f_currencyType) {
        this.f_currencyType = f_currencyType;
    }
    
    public String getF_currencyType_op() {
        return this.f_currencyType_op;
    }
    
    public void setF_currencyType_op(String f_currencyType_op) {
        this.f_currencyType_op = f_currencyType_op;
    }
   
    public String getF_accountType() {
        return this.f_accountType;
    }
    
    public void setF_accountType(String f_accountType) {
        this.f_accountType = f_accountType;
    }
    
    public String getF_accountType_op() {
        return this.f_accountType_op;
    }
    
    public void setF_accountType_op(String f_accountType_op) {
        this.f_accountType_op = f_accountType_op;
    }
