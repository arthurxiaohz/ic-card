...
public class TblStlCheckDetailPageInfo extends PageInfoView{

	protected  Integer  f_id;
 	protected  String  f_id_op;
	protected  String  f_checkBatchId;
 	protected  String  f_checkBatchId_op;
	protected  String  f_orgId;
 	protected  String  f_orgId_op;
	protected  String  f_orgType;
 	protected  String  f_orgType_op;
	protected  String  f_checkDate;
 	protected  String  f_checkDate_op;
	...
	protected  Integer  f_inProcess;
 	protected  String  f_inProcess_op;
	protected  String  f_txOrgOrderId;
 	protected  String  f_txOrgOrderId_op;
    ...
    public String getF_checkBatchId() {
        return this.f_checkBatchId;
    }
    
    public void setF_checkBatchId(String f_checkBatchId) {
        this.f_checkBatchId = f_checkBatchId;
    }
    
    public String getF_checkBatchId_op() {
        return this.f_checkBatchId_op;
    }
    
    public void setF_checkBatchId_op(String f_checkBatchId_op) {
        this.f_checkBatchId_op = f_checkBatchId_op;
    }
    ...
    public String getF_orgType() {
        return this.f_orgType;
    }
    
    public void setF_orgType(String f_orgType) {
        this.f_orgType = f_orgType;
    }
    
    public String getF_orgType_op() {
        return this.f_orgType_op;
    }
    
    public void setF_orgType_op(String f_orgType_op) {
        this.f_orgType_op = f_orgType_op;
    }
   
    public String getF_checkDate() {
        return this.f_checkDate;
    }
    ...
    public Integer getF_inProcess() {
        return this.f_inProcess;
    }
    
    public void setF_inProcess(Integer f_inProcess) {
        this.f_inProcess = f_inProcess;
    }
    
    public String getF_inProcess_op() {
        return this.f_inProcess_op;
    }
    
    public void setF_inProcess_op(String f_inProcess_op) {
        this.f_inProcess_op = f_inProcess_op;
    }
   
    public String getF_txOrgOrderId() {
        return this.f_txOrgOrderId;
    }
    
    public void setF_txOrgOrderId(String f_txOrgOrderId) {
        this.f_txOrgOrderId = f_txOrgOrderId;
    }
    
    public String getF_txOrgOrderId_op() {
        return this.f_txOrgOrderId_op;
    }
    
    public void setF_txOrgOrderId_op(String f_txOrgOrderId_op) {
        this.f_txOrgOrderId_op = f_txOrgOrderId_op;
    }
