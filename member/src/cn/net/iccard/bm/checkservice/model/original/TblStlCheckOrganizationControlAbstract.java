...
public abstract class TblStlCheckOrganizationControlAbstract extends BaseObject implements Serializable{
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TblStlCheckOrganizationControl) ) return false;
		 TblStlCheckOrganizationControl castOther = ( TblStlCheckOrganizationControl ) other; 
   ...
   public int hashCode() {
        ...
        hcb.append(getId());
		hcb.append("TblStlCheckOrganizationControl".hashCode());
