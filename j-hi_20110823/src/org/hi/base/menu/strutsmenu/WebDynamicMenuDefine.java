...
public class WebDynamicMenuDefine {
	...
	public String getRootJsFunction() {
		return rootJsFunction;
	}

	public void setRootJsFunction(String rootJsFunction) {
		this.rootJsFunction = rootJsFunction;
	}
