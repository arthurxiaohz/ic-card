...
public class HiConfigHolder {
	...
	public static String getUserPassword(){
		String password = getProperties().getProperty("hi.security.user.password");
		ObjectNull();
		return password;
	}
	...
	public static String getHelper(){
		String helper = getProperties().getProperty("hi.view.framework.helper");
		ObjectNull();
		if(helper == null || helper.trim().equals(""))
			return "false";
		return helper;
	}	
}
